...
<Steps>
  <Step>
    ...
    <StepContent>
      ...
      ```bash
      npm install @liveblocks/client @liveblocks/yjs yjs @tiptap/vue-3 @tiptap/pm @tiptap/starter-kit @tiptap/extension-collaboration @tiptap/extension-collaboration-cursor @tiptap/y-tiptap
      ```
    </StepContent>
